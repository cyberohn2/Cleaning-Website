...
const Testimonials = () =>{
    return(
        <div className="py-[56px] flex items-center justify-between">
            <div className="w-[375px]">
                ...
                <div className="flex items-center gap-[9px]">
                    <button className="border border-[#36B864] rounded-[4.5px] p-[12px] text-[#111d15] flex items-center justify-center">
                        <img src={rightArrow} alt="" />  
                    </button>
                    <button className="bg-[#36B864] rounded-[4.5px] p-[12px] flex items-center justify-center">
                        <img src={rightArrow} className="rotate-180" alt="" />
                    </button>
                </div>
            </div>
            <div className="p-[15px] flex w-[450px] rounded-[15px] shadow-sm border-t-[7.5px] border-r-[7.5px] border-[#36B864]">
                <img className="w-[127.5px] mr-[18px] rounded-[7.5px]" src={avatar} />
                <div>
                    <div className="flex items-center justify-between mb-[12px]">
                        ...
                        <div className="p-2 rounded-[3px] bg-[#36B864] flex items-center justify-center"><img src={quotePng} alt="" /></div>
                    </div>
