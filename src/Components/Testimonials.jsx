        ...
        <div className="max-w-[1080px] mx-auto px-8 py-[56px] flex flex-col sm:items-start sm:flex-row justify-between gap-8">
            <div className="w-[375px]">
                ...
                <div className="flex items-center gap-[9px]">
                    <button className="border border-[#36B864] hover:bg-[#36B864] rounded-[4.5px] p-[12px] text-[#111d15] flex items-center justify-center">
                        <img className="rotate-180" src={rightArrow} alt="" />  
                    </button>
                    <button className="bg-[#36B864] hover:bg-[#40c26b] rounded-[4.5px] p-[12px] flex items-center justify-center">
                        <img src={rightArrow}  alt="" />
                    </button>
                </div>
            </div>
            <div className="p-[15px] flex max-w-[450px] rounded-[15px] shadow-sm border-t-[7.5px] border-r-[7.5px] border-[#36B864]">
